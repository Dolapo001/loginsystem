...
class Login:
    def __init__(self, root):
        ...
        self.root.geometry("1199x600+100+500")
        self.root.resizable(False, False)

        #Background Image
        self.bg = ImageTk.PhotoImage(file="./image/Spiderman.jpeg")
        ...
        subtitle=Label(Frame_login, text="Members Login Here", font=("Goudy old style", 15,"bold" ),fg="#1d1d1d", bg="white").place(x=90,y=100)
        ...
        Submit = Button(Frame_login, command=self.check_function,cursor="hand2",text="Login?", bd=0,font=("Goudy old style", 15),fg="#6162FF", bg="white").place (x=90, y=320, width=188, height=40)

    def check_function(self):
            if self.username.get() == "" or self.password.get()== "":
                messagebox.showerror("Error", "All fields are required",parent=self.root)
            elif self.username.get() !="Dorhlie peeh" or self.password.get() != "123456":
